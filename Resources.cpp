...
void Resources::load()
{
	...
	texs[0].push_back(Texture("Textures/enemy-portal-spawn-anim.png", "mask", GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE));
	//Texture noSpecularTex = 1
	texs[0].push_back(Texture("Textures/no-specular.png", "mask", GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE));
	//Texture arcadeMonitorTex = 0
	texs[1].push_back(Texture("Textures/arcade-monitor.png", "tex", GL_TEXTURE1, GL_RGBA, GL_UNSIGNED_BYTE));
	//Texture arcadeMachineTex = 1
	texs[1].push_back(Texture("Textures/arcade.png", "tex", GL_TEXTURE1, GL_RGBA, GL_UNSIGNED_BYTE));
	//Texture brickUnitTex = 2
	texs[1].push_back(Texture("Textures/brick-unit-skins.png", "tex", GL_TEXTURE1, GL_RGBA, GL_UNSIGNED_BYTE));
